        ...
        <div class="col-xs-12 padding-right-clear padding-left-clear rightarea user account-box">
            <div class="col-xs-12 rightarea-con">
                <div class="user-top-icon">
                    ...
                    <div class="user-right" style='min-width:733px;'>
                        <Row style='margin-bottom:10px;'>
                            ...
                            <Col span="12">
                                <i class="m1"></i>
                                <div class="itp" >{{$t('uc.tradeNumber')}}：{{user.transactions}}</div>
                            </Col> 
                            <!--<Col span="8">
                                <i class="m3"></i>
                                <div class="itp" v-if="user.realVerified==0&&user.phoneVerified==0&&user.fundsVerified==0">{{$t('uc.safeLevelLow')}}</div>
                        ...
                        <Row :gutter="16" class='rowMiddle'>
                            <Col span="12">
                                <div>{{$t('common.registrationTime')}}：{{user.createTime}}</div>
                            </Col>
                            <Col span="12">
                                <div>
                                    {{$t('common.firstTradingTime')}}：{{user.transactionTime}}
                                </div>
                            </Col>
                        </Row>
                    </div> 
                    ...
                    <div class="account-in">
                        ...
                        <!-- <div class="account-item" >
                            <div class="account-item-in">
                                ...
                                <span class="card-number">{{$t('common.nickname')}}</span>
                                <p class="bankInfo" style="color: grey;">
                                    {{user.username}}
                                </p> 
                             
                                 <a  class="btn" @click="showItem(1)">{{$t('common.modify')}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==1">
                                <div class="detail-list" style="width: 80%;">
                                    <Form ref="formValidate1" :model="formValidate1" :rules="ruleValidate" :label-width="85">
                                        
                                        <FormItem :label="$t('common.nickname')" prop="username">
                                            <Input v-model="formValidate1.username" size="large"></Input>
                                        </FormItem>
                                      
                                       
                                       <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate1')" style="margin-left: -85px">{{$t('common.save')}}</Button>
                                            <Button type="ghost" @click="handleReset('formValidate1')" style="margin-left: 8px">{{$t('common.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                                ...
                                <div class="detail-list">
                                    <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate" :label-width="90">
                                        ...
                                        <FormItem :label="$t('common.newLoginPw')" prop="newPw">
                                            <Input v-model="formValidate4.newPw" size="large" type="password" :placeholder='$t("common.passwordRule")'></Input>
                                        </FormItem>
                                        <!-- newPwConfirm -->
                                        <FormItem :label="$t('common.newPwConfirm')" prop="newPwConfirm">
                                            <Input v-model="formValidate4.newPwConfirm" size="large" type="password" :placeholder='$t("common.passwordRule")'></Input>
                                        </FormItem>
                                        <!-- 手机验证码 -->
                                ...
                                <div class="detail-list" v-show="user.fundsVerified==1">
                                    <Form ref="formValidate5" :model="formValidate5" :rules="ruleValidate" :label-width="90">
                                        ...
                                        <FormItem :label="$t('common.newPriceW')" prop="newMPw">
                                            <Input v-model="formValidate5.newMPw" size="large" type="password"  :placeholder='$t("common.passwordRule")'></Input>
                                        </FormItem>
                                        <!-- newMPwConfirm -->
                                        <FormItem :label="$t('common.newPwConfirm')" prop="newMPwConfirm">
                                            <Input v-model="formValidate5.newMPwConfirm" size="large" type="password"  :placeholder='$t("common.passwordRule")'></Input>
                                        </FormItem>
                                        <!-- 邮箱验证码 -->
    ...
    data() {
        ...
        return {
            ...
            ruleValidate: {
                ...
                realName: [
                    { required: true, message: this.$t('uc.realNameRule'), min:2, trigger: 'blur' }
                ],
                idCard: [
                    { required: true, message: this.$t('uc.idCardRule'),  min: 3, max:38, trigger: 'blur' }
                ],
    ...
    methods: {
        ...
        submit(name) {
            ...
            if (name == 'formValidate1') {
                 let param = {};
                 param['username'] = this.formValidate1.username;
                //  this.$http.post('http://8ecee4fa.ngrok.io'+ '/uc/member/nickName', param).then(response => {
                this.$http.post(this.host+ '/uc/member/nickName', param).then(response => {
