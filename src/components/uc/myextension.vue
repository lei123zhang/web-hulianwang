...
export default {
            ...
            tablePromoteFriends:[
                ...
                },
                {
                  ...
                  render:function(h,params){
                    return (parseInt(params.row.level)+1)+self.$t('uc.extension.level')
                  }
                }
            ],
            dataPromoteFriends:[],
    ...
    methods: {
        ...
        qrcodeM(){
            ...
            this.qrcode.value="http://hlt.wxmarket.cn/#/register?agent="+promotionCode;
            // this.qrcode.value="http://www.bid-buy.net/#/register?agent="+promotionCode;
        },
        onCopy(e) {
