<template>
    <div class="nav-right">
        <P class='nav-right-tit'><span>{{$t('common.deposit')}}</span></P>
                    ...
                    <div class="table-inner action-box open">
                        ...
                        <div class="action-inner">
                            <div class="inner-left">
                                ...
                                <Select v-model="coinType" style="width:115px;margin-top: 23px;" @on-change="changeCoin" :placeholder="$t('common.pleaseSelect')">
                        ...
                        <div class="action-content">
                            <div class="action-body">
                                ...
                                <p class="acb-p2">• {{$t('finance.rechargeTip1')}}<br>• {{$t('finance.rechargeTip2')}}<br>• {{$t('finance.rechargeTip4')}}<br>• {{$t('finance.rechargeTip5')}}</p>
                            </div>
                        </div>
                        <div class="action-content">
                            <div class="action-body">
                                ...
                                <div class="order-table">
                                    ...
                                    <div style="margin: 10px;overflow: hidden">
                                        <div style="float: right;">
                                            <Page :total="dataCount" :current="1"  :pageSize="pageSize"  @on-change="changePage"></Page>
                                        </div>
                                    </div>
