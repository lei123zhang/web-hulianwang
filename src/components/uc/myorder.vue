...
export default {
    ...
    methods: {
        ...
        changePage(index) {
            if (this.whichItem == 1) {
              this.getOrder(1,index-1)
            } else if (this.whichItem == 2) {
               this.getOrder(2,index-1)
            } else if (this.whichItem == 3) {
               this.getOrder(3,index-1)
            } else if (this.whichItem == 0) {
              this.getOrder(0,index-1)
            } else if (this.whichItem == 4) {
              this.getOrder(4,index-1)
            }else{
        ...
        getOrder(status,pageNo) {
            this.$http.post(this.host + '/otc/order/self'+'?pageNo='+pageNo +'&pageSize='+ this.pageSize+'&status='+status).then(response => {
                var resp = response.body;
           
                if (resp.code == 0 && response.body.data.content) {
