<template>
    <div class="help">
        ...
        <div class="help_container clearDiv" style="width:100%;max-width:1310px;min-width:1180px;padding:0 10px;margin:0 auto;color:#000;font-size:18px;">
            ...
            <Col span="7">
                ...
                <!-- <router-link to="{ path: '/newhelp', query: { 'status': 0 }}"> -->
        ...
        <div class='clearDiv' style="width:100%;max-width:1310px;min-width:1180px;padding:0 10px;margin:0 auto 50px;color:#000;font-size:18px;">    
            <Col span="24" >
